...
import { BrowserRouter, Routes, Route, HashRouter, Switch, Layout,Outlet } from 'react-router-dom';
...
<Footer />
      ...
      <Routes>
         ...
         {/* <Route path='about/*' >
         <Route index element={<About  type='about-us'/>} />
         ...
         <Route path='*' element={<Error />} />
          ...
          <Route path='insight/*'>
          <Route index element={<Insight type='insights'/>} />
